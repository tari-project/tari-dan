...
use crate::{signature::TransactionSignatureFields, SubstateRequirement, Transaction, TransactionSignature};
...
pub struct TransactionBuilder {
    ...
    outputs: Vec<SubstateRequirement>,
...
impl TransactionBuilder {
    ...
    pub fn add_output(mut self, output_object: SubstateRequirement) -> Self {
    ...
    pub fn with_outputs<I: IntoIterator<Item = SubstateRequirement>>(mut self, outputs: I) -> Self {
        self.outputs.extend(outputs);
        self
    }

    pub fn add_output_ref(mut self, output_object: SubstateRequirement) -> Self {
        self.outputs.push(output_object);
        self
    }
