...
#        When I check the balance of ACC_2 on wallet daemon WALLET_D the amount is at least 50
    ...
    # TODO: Not working at the moment (wallet doesn't seem to recognise the claim)
#    @serial
...
#        When I print the cucumber world
#        When I wait 3 seconds
#        When I check the balance of ACCOUNT_1 on wallet daemon WALLET_D the amount is at least 1000
